...
feriado_opcao = st.radio(
    ...
    ('Nenhum', 'Feriado', 'Pré-feriado', 'Pós-feriado')
)
...
st.markdown("### Informe as quantidades vendidas nos 5 dias anteriores")
st.write("Preencha as quantidades de refeições vendidas em cada um dos últimos 5 dias para ajudar na previsão.")
